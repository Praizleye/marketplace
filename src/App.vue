<template>
  <div class="banner-1 pb-12">
    ...
    <div class="flex justify-center items-center flex-col mt-3 md:mt-6">
      <div class="text-center">
        <span class="text-yellow-400 italic text-sm md:text-3xl">Making </span>
        <span class="text-yellow-400 italic text-sm md:text-3xl font-bold"
      ...
      >
        ...
        <div class="text-center mt-3 md:mt-6 text-white">
          ...
          <div>26th July 2024, 9:00A.M</div>
        </div>
      </div>
    </div>
  </div>
  ...
  >
    <div class="flex justify-center items-center">
      <div class="w-7/12 p-12">
        <h2
          class="text-gray-900 md:text-6xl text-2xl font-Eczar mb-5 font-bold"
        >
      ...
      <div class="w-5/12 pr-28">
        <div class="flex flex-wrap justify-end gap-2">
          <button
            class="bg-blue-800 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded"
          >
            <svg
    ...
    <div class="pb-3">
      <a class="underline text-2xl text-blue-600 font-work_sans"
        >📧 hire@marketplaceafrica.com</a
      >
      <div class="text-xs text-center font-bold">
        For Further Inquiries: 08038574803 | 098488948789
      </div>
    </div>
  </div>
  <div
